...
def _impl(ctx):
  ...
  compiler_path = "/usr/bin/arm-none-eabi-gcc"
  assembler_path = "/usr/bin/arm-none-eabi-gcc"
  archiver_path = "/usr/bin/arm-none-eabi-ar"
  linker_path = "/usr/bin/arm-none-eabi-gcc"
  strip_path = "/usr/bin/arm-none-eabi-objcopy"
